import 'package:crypto_list/app/data/models/volume_data.dart';
  ...
  factory Quote.fromJson(Map<String, dynamic> json) {
    return Quote(
      ...
      regularMarketChangePercent:
          VolumeData.fromJson(json['regularMarketChangePercent']),
      ...
      regularMarketPreviousClose:
          VolumeData.fromJson(json['regularMarketPreviousClose']),
      regularMarketPrice: VolumeData.fromJson(json['regularMarketPrice']),
      regularMarketTime:
          VolumeAllCurrencies.fromJson(json['regularMarketTime']),
      volumeAllCurrencies:
          VolumeAllCurrencies.fromJson(json['volumeAllCurrencies']),
    );
  }
}
